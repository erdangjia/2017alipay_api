...
<header class="am-header">
        <h1>二当家的2017最新支付宝电脑网站支付体验入口页</h1>
</header>
<div id="main">
...
：</dt>
                    ...
                    <dt>商品描述：</dt>
                    <dd>
                        <input id="WIDbody" name="WIDbody" value="二当家的2017最新支付宝测试"/>
                    </dd>
                    <hr class="one_line">
                    <dt></dt>
                    <dd id="btn-dd">
...
：</dt>
        ...
        <div id="foot">
			<ul class="foot-ul">
				<li>
					二当家的素材网版权所有 2015-2018 <a href="http://www.erdangjiade.com">erdangjiade.com</a> 
				</li>
			</ul>
		</div>
	</div>
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "二当家的2017最新支付宝测试";
